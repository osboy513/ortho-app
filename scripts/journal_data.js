const journalCategories = [
    {
        id: "general",
        name: "General Orthopedics (정형외과 일반)",
        journals: [
    ...
    {
        id: "arthroplasty",
        name: "Arthroplasty / Joint Replacement (관절 치환술)",
        journals: [
    ...
    },
    {
        ...
        name: "Sports Medicine & Arthroscopy (스포츠 의학 및 관절경)",
        journals: [
    ...
    {
        id: "trauma",
        name: "Orthopaedic Trauma (정형외과 외상)",
        journals: [
    ...
    },
    {
        ...
        name: "Hand & Upper Extremity (수부 및 상지)",
        journals: [
    ...
    {
        id: "pediatric",
        name: "Pediatric Orthopedics (소아정형)",
        journals: [
    ...
    },
    {
        ...
        name: "Bone, Cartilage & Orthopaedic Research (골/연골/기초연구)",
        journals: [
    ...
    },
    {
        ...
        name: "Rehabilitation, Biomechanics & Orthotics (재활/생역학/보조기)",
        journals: [
    ...
    {
        id: "imaging",
        name: "Musculoskeletal Imaging (근골격 영상)",
        journals: [
